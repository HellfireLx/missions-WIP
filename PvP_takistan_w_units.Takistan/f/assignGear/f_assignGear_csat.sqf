...
// Woodland-Hex
_baseUniform = ["TRYK_ZARATAKI2"];
_baseHelmet = ["TRYK_H_pakol2"];
_baseGlasses = [];
...
// LOADOUT: SQUAD LEADER
	case "dc":
	{
		...
		// Uniform Gear
		for "_i" from 1 to 3 do {this addItemToUniform _bandages;};
		for "_i" from 1 to 1 do {this addItemToUniform _morphine;};
...
// LOADOUT: MEDIC
	case "m":
	{
		...
		(unitBackpack _unit) additemCargoGlobal [_smokegrenadered, 2];
		(unitBackpack _unit) additemCargoGlobal [_smokegrenadegreen, 1];
	};
...
// LOADOUT: AUTOMATIC RIFLEMAN
	case "ar":
	{
		...
		// Uniform Gear
		for "_i" from 1 to 2 do {this addItemToUniform _bandages;};
		for "_i" from 1 to 1 do {this addItemToUniform _morphine;};
		for "_i" from 1 to 1 do {this addItemToUniform _ARmag;};
...
// LOADOUT: ASSISTANT AUTOMATIC RIFLEMAN
	case "aar":
	{
		...
		for "_i" from 1 to 3 do {this addItemToUniform _bandages;};
		for "_i" from 1 to 1 do {this addItemToUniform _morphine;};
		for "_i" from 1 to 3 do {this addItemToUniform _riflemag;};
...
// LOADOUT: RIFLEMAN (AT)
	case "rat":
	{
		...
		for "_i" from 1 to 3 do {this addItemToUniform _bandages;};
		for "_i" from 1 to 1 do {this addItemToUniform _morphine;};
		for "_i" from 1 to 3 do {this addItemToUniform _carbinemag;};
